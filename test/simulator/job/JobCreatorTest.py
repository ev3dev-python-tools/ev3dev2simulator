...
from simulator.state.JobCreator import JobCreator

from simulator.state.RobotState import get_job_handler
...
class JobCreatorTest(unittest.TestCase):
    ...
    def test_create_jobs_left(self):
        ...
        job_creator.create_drive_command(20, 100, 'hold', 'left')
        for i in range(300):
    ...
    def test_create_jobs_right(self):
        ...
        job_creator.create_drive_command(80, 200, 'hold', 'right')
        for i in range(150):
    ...
    def test_create_jobs_coast(self):
        ...
        job_creator.create_drive_command(20, 100, 'coast', 'left')
        for i in range(300):
            job = job_handler.next_left_move_job()
            self.assertAlmostEqual(job.distance, 0.106, 3)
