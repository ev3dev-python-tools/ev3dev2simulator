...
class TestDeviceConnector(unittest.TestCase):
    ...
    def test_give_existing_port(self):
        with patch('ev3dev2.connector.DeviceConnector.get_client_socket') as Device_get_client_socketMock:
            with patch('ev3dev2.connector.SensorConnector.get_client_socket') as get_client_socketMock:
