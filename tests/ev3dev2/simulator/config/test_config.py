...
class TestConfig(unittest.TestCase):
    ...
    def test_load_config(self):
        with patch('ev3dev2simulator.config.config.Config') as ConfigMock:
            ...
            self.assertEqual(args, ('config_large',))
    ...
    def test_load_word_config(self):
        ...
        self.assertEqual(args, ('world_configurations/config_large',))
        ...
        self.assertEqual(args, ('world_configurations/config_small',))
